...
import { LssITA20ListAPI, LssITA20DeleteAPI } from "../../data";
import NavMenu from "../fragments/NavMenu";
import { FaBars } from "react-icons/fa";
import Swal from "sweetalert2";
import ObjOpen from "./LssITA20ListModal";
import "./LssITA20ConfigList.scss";
...
const LssITA20List = () => {
  ...
  const RemoveData = (_code: string) => {
    if (_code !== "") {
      ...
      LssITA20DeleteAPI(para).then((data: any) => {
        fetchData();
        return "succ";
      });
    }
        ...
        <Card.Header>
          <Row style={{ display: "flex", flexDirection: "row" }}>
            <Col md="6" style={{ lineHeight: "45px" }}>
              LSS-IT-A20 กำหนดการ ACTIVATE EMAIL ของบริษัทประกันภัย
            </Col>
